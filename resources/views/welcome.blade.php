    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
                    <img class="d-block w-100" src="https://srv-file5.gofile.io/download/EsrmBo/014179920450_16_40_45.jfif" alt="First slide" height="340"/>
        ...
        <div class="carousel-item">
                    <img class="d-block w-100" src="https://srv-file5.gofile.io/download/EsrmBo/314179920780_16_41_18.jfif" alt="Second slide" height="340"/>
                    <div class="carousel-caption d-none d-md-block">
                    <div class="img-title" style="text-align: left;margin-left:-120px;margin-bottom:-20px;display:flex" width="200px">
                        <div class="espaceetudiant" style="display: flex;padding-top: 10px">
                          <img src="https://srv-file19.gofile.io/download/6aeNCi/014159070600_20_31_00.png" alt="Etudiant avatar" width="70px" height="70px">
              ...
              <div class="carousel-item">
                    <img class="d-block w-100" src="https://srv-file5.gofile.io/download/EsrmBo/314179921170_16_41_57.jfif" alt="3eme slide" height="340"/>
                    <div class="carousel-caption d-none d-md-block">
                    <div class="img-title" style="text-align: left;margin-left:-120px;margin-bottom:-20px;display:flex" width="200px">
                        <div class="espaceentreprise" style="display: flex;padding-top: 10px">
                          <img src="https://srv-file19.gofile.io/download/6aeNCi/214159071080_20_31_48.png" alt="Etudiant avatar" width="70px" height="70px">
                          <div class="desc" style="background-color:  #f4c312 ;opacity: 90%;display: flex;padding-top: 10px" width="100px" height="70px">
                          <ul style="display: block">
                            <li style="list-style: none;font-size: 18px;color: #006daa">
                            Espace Entreprise
              ...
              <div class="carousel-item">
                    <img class="d-block w-100" src="https://srv-file5.gofile.io/download/EsrmBo/314179921170_16_41_57.jfif" alt="First slide" height="340"/>
                    <div class="carousel-caption d-none d-md-block">
                    <div class="img-title" style="text-align: left;margin-left:-120px;margin-bottom:-20px;display:flex" width="200px">
                        <h5>
                          <b style="background-color: #f4c312;padding: 5px;opacity: 90%"> ISET de Bizerte vous souhaite la bienvenue </b> <br>
  ...
  <div class="lfa">
      ...
      <br>
          ...
          <div class="av" style="margin-left: 20px">
            ...
            <input type="checkbox" name="" id=""><b>Parfaite </b><br>
            <input type="checkbox" name="" id=""><b>Bonne </b><br>
            <input type="checkbox" name="" id=""><b>Moyenne </b><br>
            <input type="checkbox" name="" id=""><b>Mauvaise </b><br>
