  ...
  <div class="col">
    <div class="form-group">
      <label for="date_debut">Date debut</label>
         <input type="text" name="date_debut" value="{{ old('date_debut') ?? $stage->date_debut }}" id="date_debut" class="form-control" placeholder="">
  ...
  <div class="col">
    <div class="form-group">
      <label for="date_fin">Date fin</label>
         <input type="text" name="date_fin" value="{{ old('date_fin') ?? $stage->date_fin }}" id="date_fin" class="form-control" placeholder="">
